...
TString OUTDIRECTORY="/home/jackbauer/ALICE_HeavyFlavour/work/jets2/pPb_run2/DzeroR03_RefDPt3PythiaEff_BaseCuts";
const int ND = 2;
const int NDMC = 2;
...
double fptbinsJetTrueA[fptbinsJetTrueN+1] = {2,3,4,5,6,8,10,14,20,30,50 };
