...
PriorNames = ["Def MC", "z*j", "1/z * 1/j", "1/z", "z", "1/j", "j", "z/j", "j/z"]
...
cp.SetLogz()
for i in range(9):
    #hpZ = priorfile[i].hGenRebin
    #print(priorfile[i])
    #cp.cd(i+1)
    #cp.cd(i+1).SetLogz()
    #hpZ.SetTitle(str(i))
    #hpZ.DrawCopy('colz1' , 'h' + str(i) + 'plothist')
...
############# --------------------------------------------------------
plt.figure()
plt.hlines(SimpleVarRatio(hist[1],hist[0]),binlowedges,binupedges,label='Steeper prior z*j',colors='red')
plt.hlines(SimpleVarRatio(hist[2],hist[0]),binlowedges,binupedges,label='Gentler prior 1/z * 1/j',colors='blue')
plt.hlines(SimpleVarRatio(hist[3],hist[0]),binlowedges,binupedges,label='Gentler prior 1/z',colors='green')
plt.hlines(SimpleVarRatio(hist[4],hist[0]),binlowedges,binupedges,label='Steeper prior z',colors='orange')
plt.hlines(SimpleVarRatio(hist[5],hist[0]),binlowedges,binupedges,label='Gentler prior 1/j',colors='yellowgreen')
plt.hlines(SimpleVarRatio(hist[6],hist[0]),binlowedges,binupedges,label='Steeper prior j',colors='purple')
plt.hlines(SimpleVarRatio(hist[7],hist[0]),binlowedges,binupedges,label='Prior z/j',colors='peru')
plt.hlines(SimpleVarRatio(hist[8],hist[0]),binlowedges,binupedges,label='Prior j/z',colors='indigo')
...
plt.figure()
plt.hlines(FinalRMS(hist[1:],hist[0]),binlowedges,binupedges,label='',colors='red')
