...
void makeTFile4CutsD0Correlations_pp2017_L3(Bool_t isOnData=kTRUE) {
...
// Cuts for D0 cuts
  ...
  Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,350.*1E-4, 0.8, 0.5, 0.5, 1000.*1E-4, 1000.*1E-4, -20000. *1E-8, 0.75,  0.,0.},/* pt<0.5*/
                                                  {0.400,350.*1E-4, 0.8, 0.5, 0.5, 1000.*1E-4, 1000.*1E-4, -20000. *1E-8, 0.75,  0.,0.},/* 0.5<pt<1*/
                                                  {0.400,300.*1E-4, 0.8, 0.4, 0.4, 1000.*1E-4, 1000.*1E-4, -20000.*1E-8, 0.75,  0.,0.},/* 1<pt<2 */
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -17000.*1E-8, 0.75,   0.,0.},/* 2<pt<3 *///d0d0 e cosp
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -10000.*1E-8, 0.75,   0.,0.},/* 3<pt<4 */
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -6000. *1E-8, 0.75,  0.,0.},/* 4<pt<5 */
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -6000. *1E-8, 0.75,  0.,0.},/* 5<pt<6 */
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -6000. *1E-8, 0.75,  0.,0.},/* 6<pt<7 */
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -5000. *1E-8, 0.75,  0.,0.},/* 7<pt<8 */
                                                  {0.400,300.*1E-4, 0.9, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -3000. *1E-8, 0.75,  0.,0.},/* 8<pt<10 */
                                                  {0.400,300.*1E-4, 0.9, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -3000. *1E-8, 0.75,  0.,0.},/* 10<pt<12 */
                                                  {0.400,300.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, 12000. *1E-8, 0.75,  0.,0.},/* 12<pt<16 */
                                                  ...
                                                  {0.400,300.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, 999999.*1E-8, 0.75,  0.,0.},/* 36<pt<50 */
                                                  {0.400,300.*1E-4, 1.0, 0.6, 0.6, 1000.*1E-4, 1000.*1E-4, 999999.*1E-8, 0.7,   0.,0.}};/* pt>50 */
 ...
 //CREATE TRANSPOSE MATRIX...REVERSE INDICES as required by AliRDHFCuts
  ...
  RDHFD0Corr->PrintAll();
  TFile* fout=new TFile("D0toKpiCuts_Std_pp2017_L3.root","recreate");   //set this!! 
