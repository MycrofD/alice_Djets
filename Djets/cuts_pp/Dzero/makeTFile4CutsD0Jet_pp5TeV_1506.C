...
// Cuts for D0 cuts
  ...
  Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,300.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-50000.*1E-8,0.95,0.,5.},   /*BIN 0*/ /* pt<0.5*/ 
                                                  ...
                                                  {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4, 10000.*1E-8,0.9,0.,0.},  /*BIN 11*/ /* 12<pt<16 */
                                                  {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4, 10000.*1E-8,0.85,0.,0.},  /*BIN 12*/ /* 16<pt<24 */
                                                  {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4, 999999.*1E-8,0.85,0.,0.}, /*BIN 13*/ /* 24<pt<36 */
                                                  {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4, 999999.*1E-8,0.85,0.,0.}, /*BIN 14*/ /* 36<pt<50 */
                                                  {0.400,300.*1E-4,1.0,0.6,0.6,1000.*1E-4,1000.*1E-4, 999999.*1E-8,0.8,0.,0.}}; /*BIN 15*/ /* pt>50 */
...
//  RDHFD0Corr->SetOptPileup(AliRDHFCuts::kRejectPileupEvent);
 ...
 /* if(isOnData) {
  ...
  TFile* fout;
  if(isOnData) fout=new TFile("D0toKpiCuts_pp5TeV_150618.root","recreate");   //set this!! 
  else fout=new TFile("D0toKpiCuts_pp5TeV_150618.root","recreate");   //set this!! 
