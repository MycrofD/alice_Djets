...
void makeTFile4CutsD0Correlations_pp2017_T3(Bool_t isOnData=kTRUE) {
...
// Cuts for D0 cuts
  ...
  Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -40000.*1E-8, 0.95, 0.,5.},/* pt<0.5*/
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -40000.*1E-8, 0.95, 0.,5.},/* 0.5<pt<1*/
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -40000.*1E-8, 0.95, 0.,5.},/* 1<pt<2 */
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -40000.*1E-8, 0.95, 0.,5.},/* 2<pt<3 *///d0d0 e cosp
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -40000.*1E-8, 0.95, 0.,5.},/* 3<pt<4 */
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -20000.*1E-8, 0.95, 0.,5.},/* 4<pt<5 */
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -15000.*1E-8, 0.95, 0.,4.},/* 5<pt<6 */
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  -12000.*1E-8, 0.95, 0.,4.},/* 6<pt<7 */
                                                  {0.400,275.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  -12000.*1E-8, 0.95, 0.,4.},/* 7<pt<8 */
                                                  {0.400,275.*1E-4, 0.9, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  -8000.*1E-8, 0.95, 0.,3.},/* 8<pt<10 */
                                                  {0.400,275.*1E-4, 0.9, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  -8000.*1E-8, 0.95, 0.,3.},/* 10<pt<12 */
                                                  {0.400,275.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  5000.*1E-8, 0.95, 0.,3.},/* 12<pt<16 */
                                                  {0.400,275.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  5000.*1E-8, 0.95, 0.,3.},/* 16<pt<20 */
                                                  {0.400,275.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  5000.*1E-8, 0.95, 0.,3.},/* 20<pt<24 */
                                                  {0.400,275.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  5000.*1E-8, 0.90, 0.,3.},/* 24<pt<36 */
                                                  {0.400,275.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  5000.*1E-8, 0.90, 0.,3.},/* 36<pt<50 */
                                                  {0.400,275.*1E-4, 1.0, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4,  5000.*1E-8, 0.90, 0.,3.}};/* pt>50 */

//topomatic cut
  Float_t d0Topomatic[nptbins] = {1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5,1.5};
 ...
 //CREATE TRANSPOSE MATRIX...REVERSE INDICES as required by AliRDHFCuts
  ...
  RDHFD0Corr->PrintAll();
  TFile* fout=new TFile("D0toKpiCuts_Std_pp2017_T3.root","recreate");   //set this!! 
...
//esdHadrCuts->SetClusterRequirementITS(AliESDtrackCuts::kSPD,AliESDtrackCuts::kAny);
  ...
  TFile* fout=new TFile("AssocPartCuts_Std_pp2017.root","recreate");   //set this!! 
  fout->cd();
