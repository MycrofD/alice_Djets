...
void makeTFile4CutsD0Correlations_pp2017_L2(Bool_t isOnData=kTRUE) {
...
// Cuts for D0 cuts
  ...
  Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,350.*1E-4, 0.8, 0.5, 0.5, 1000.*1E-4, 1000.*1E-4, -25000. *1E-8, 0.8,  0.,0.},/* pt<0.5*/
                                                  {0.400,350.*1E-4, 0.8, 0.5, 0.5, 1000.*1E-4, 1000.*1E-4, -25000. *1E-8, 0.8,  0.,0.},/* 0.5<pt<1*/
                                                  {0.400,300.*1E-4, 0.8, 0.4, 0.4, 1000.*1E-4, 1000.*1E-4, -25000.*1E-8, 0.8,  0.,0.},/* 1<pt<2 */
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -20000.*1E-8, 0.8,   0.,0.},/* 2<pt<3 *///d0d0 e cosp
                                                  {0.400,300.*1E-4, 0.8, 0.7, 0.7, 1000.*1E-4, 1000.*1E-4, -12000.*1E-8, 0.8,   0.,0.},/* 3<pt<4 */
 ...
 //CREATE TRANSPOSE MATRIX...REVERSE INDICES as required by AliRDHFCuts
  ...
  RDHFD0Corr->PrintAll();
  TFile* fout=new TFile("D0toKpiCuts_Std_pp2017_L2.root","recreate");   //set this!! 
