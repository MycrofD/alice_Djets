...
//topomatic cut
  ...
  TFile* fout;
  if(isOnData) fout=new TFile("D0toKpiCuts_pp5TeV_pPbBase_noTopo.root","recreate");   //set this!!
  else fout=new TFile("D0toKpiCuts_pp5TeV_pPbBase_noTopo.root","recreate");   //set this!!
