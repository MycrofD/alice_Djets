...
TCanvas *FinalSpectrum = new TCanvas("FinalSpectrum", "FinalSpectrum",800,800);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: FinalSpectrum_1
   ...
   CentralPointsStatisticalUncertainty__1__1->SetMaximum(1.15);
  ...
  // graeT->Draw("2"); // D-jet sys uncertanties
   ...
   // D-jets projections
    ...
    D0JetSpectrum->SetMarkerStyle(21);
   ...
   //ChJetsSysUnc->Draw("2same");
    ...
    TLegend *leg2 = new TLegend(0.12,0.65,0.5,0.7,NULL,"NB NDC");
   ...
   leg2->SetFillColor(0);
   leg2->SetFillStyle(0);
   TLegendEntry *entry=leg2->AddEntry("NULL","0-10% Pb-Pb, #sqrt{#it{s}_{NN}} = 5.5 TeV, #it{L}_{int} = 10 nb^{-1}","p");
   ...
   TLegend *leg = new TLegend(0.12,0.45,0.5,0.6,NULL,"NB NDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(43);
   leg->SetTextSize(25);
   leg->SetLineColor(1);
   ...
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
  // TLegendEntry *entry=leg->AddEntry("NULL","ALICE Preliminary, 0-20\% Pb-Pb (2015), #sqrt{#it{s}_{NN}} = 5.02 TeV","p");
   TLegendEntry *entry=leg->AddEntry("NULL","ALICE Preliminary","p");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
...
entry=leg->AddEntry("NULL","0-20\% Pb-Pb (2015), #sqrt{#it{s}_{NN}} = 5.02 TeV","");
entry=leg->AddEntry("NULL","(p-Pb data reference)","");
//entry=leg->AddEntry("NULL","0-20\% Pb-Pb (2015), #sqrt{#it{s}_{NN}} = 5.02 TeV, (p-Pb data reference)","");
   ...
   TPaveText *pt = new TPaveText(0.15,0.7,0.85,0.94,"NB NDC");
   pt->SetBorderSize(0);
   pt->SetFillStyle(0);
   pt->SetTextAlign(13);
   pt->SetTextFont(43);
   ...
   text = pt->AddText("0-10% Pb-Pb, #sqrt{#it{s}_{NN}} = 5.5 TeV, #it{L}_{int} = 10 nb^{-1}");
  ...
  // text = pt->AddText("0-10% Pb-Pb, #sqrt{#it{s}_{NN}} = 5.5 TeV, #it{L}_{int} = 10 nb^{-1}");
   ...
   FinalSpectrum->SaveAs("RaaProjections_woPrel.eps");
   FinalSpectrum->SaveAs("RaaProjections_woPrel.png");
