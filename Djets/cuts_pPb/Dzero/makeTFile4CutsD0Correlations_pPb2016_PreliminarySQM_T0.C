...
//  RDHFD0Corr->SetOptPileup(AliRDHFCuts::kRejectPileupEvent);
  ...
  TFile* fout;
  if(isOnData) fout=new TFile("D0toKpiCuts_pPb2016_0_100_PreliminarySQM_T0.root","recreate");   //set this!!
  else fout=new TFile("D0toKpiCuts_pPb2016_0_100_PreliminarySQM_MC_T0.root","recreate");   //set this!!
