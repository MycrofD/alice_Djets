...
// Cuts for D0 cuts
  ...
  RDHFD0Corr->SetPtBins(nptbins+1,ptbins);
                         ...
                         Float_t cutsMatrixD0toKpiStand[nptbins][nvars]={{0.400,300.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-36000.*1E-8,0.95,0.,3.},   /*BIN 0*/ /* pt<0.5*/
                                                                         {0.400,300.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-36000.*1E-8,0.95,0.,3.},   /*BIN 1*/ /* 0.5<pt<1*/
                                                                         {0.400,300.*1E-4,0.8,0.5,0.5,1000.*1E-4,1000.*1E-4,-25000.*1E-8,0.95,0.,3.}, /*BIN 2*/ /* 1<pt<2 */
                                                                         {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-18000.*1E-8,0.95,0.,3.}, /*BIN 3*/ /* 2<pt<3 */
                                                                         {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-18000.*1E-8,0.95,0.,3.}, /*BIN 4*/ /* 3<pt<4 */
                                                                         {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-6000.*1E-8,0.95,0.,3.}, /*BIN 5*/ /* 4<pt<5 */
                                                                         {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,-2000.*1E-8,0.95,0.,2.}, /*BIN 6*/ /* 5<pt<6 */
                                                                         {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0,0.95,0.,2.},  /*BIN 7*/ /* 6<pt<7 */
                                                                         {0.400,300.*1E-4,0.8,0.7,0.7,1000.*1E-4,1000.*1E-4,0,0.95,0.,2.},  /*BIN 8*/ /* 7<pt<8 */
                                                                         {0.400,300.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4,2000.*1E-8,0.95,0.,1.},  /*BIN 9*/ /* 8<pt<10 */
                                                                         {0.400,300.*1E-4,0.9,0.7,0.7,1000.*1E-4,1000.*1E-4,2000.*1E-8,0.95,0.,1.},  /*BIN 10*/ /* 10<pt<12 */
                                                                         {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4, 20000.*1E-8,0.95,0.,1.},  /*BIN 11*/ /* 12<pt<16 */
                                                                         {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4, 20000.*1E-8,0.90,0.,1.},  /*BIN 12*/ /* 16<pt<24 */
                                                                         {0.400,300.*1E-4,1.0,0.7,0.7,1000.*1E-4,1000.*1E-4, 20000.*1E-8,0.90,0.,1.}}; /*BIN 13*/ /* pt>24 */
...
//  RDHFD0Corr->SetOptPileup(AliRDHFCuts::kRejectPileupEvent);
  ...
  TFile* fout;
  if(isOnData) fout=new TFile("D0toKpiCuts_pPb2016_0_100_PreliminarySQM_L3.root","recreate");   //set this!!
  else fout=new TFile("D0toKpiCuts_pPb2016_0_100_PreliminarySQM_MC_L3.root","recreate");   //set this!!
