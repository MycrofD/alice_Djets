...
hDJ = fileDJ.Get("hData_binned");hDJ3 = fileDJ3.Get("hData_binned")
dirIJ = fileIJ.Get("Jets in pp 5.02 TeV")
#dirIJ = fileIJ.Get("Jets with UE subtraction in pp 5.02 TeV")
...
leg.AddEntry(hR_mb,"Pythia 8 MB (scaled by 1/30)")
leg.AddEntry(hR_soft,"Pythia 8 soft, mode 2 (scaled by 1/30)")
leg.Draw("same")
