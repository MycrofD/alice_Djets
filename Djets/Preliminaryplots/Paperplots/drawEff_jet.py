...
inFilePrompt = ROOT.TFile("/home/jackbauer/Work/alice/analysis/pp5TeV/D0jet/results_APW/Final_DzeroR0"+str(Rpar)+"_paperCuts/Default/efficiency/DjetEff_prompt_jetpt5_50.root","read");
inFileFD = ROOT.TFile("/home/jackbauer/Work/alice/analysis/pp5TeV/D0jet/results_APW/Final_DzeroR0"+str(Rpar)+"_paperCuts/Default/efficiency/DjetEff_nonPrompt_jetpt5_50.root","read");
...
pvALICE.AddText("ALICE, PYTHIA 6, pp, #sqrt{#it{s}} = 5.02 TeV");
...
pvJet.AddText("Charged Jets, Anti-#it{k}_{T}, #it{R} = 0."+str(Rpar));
...
pvEta.AddText("|#it{#eta}_{lab}^{jet}| < 0."+str(9-Rpar));
