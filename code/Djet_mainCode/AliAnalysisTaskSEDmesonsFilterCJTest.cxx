...
/*
     if(absPdg1 == 211 || absPdg1 == 321){
        if( d1->GetNDaughters() > 0 ) return kDecayOther;
    }
    if(absPdg2 == 211 || absPdg2 == 321){
        if( d2->GetNDaughters() > 0 ) return kDecayOther;
    }
