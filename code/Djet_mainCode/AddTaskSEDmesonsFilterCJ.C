...
AliAnalysisTaskSEDmesonsFilterCJTest *AddTaskSEDmesonsFilterCJ(AliAnalysisTaskSEDmesonsFilterCJTest::ECandidateType cand = AliAnalysisTaskSEDmesonsFilterCJTest::kDstartoKpipi,
                                                           ...
                                                           TString suffix = "")
{
  ...
  AliAnalysisTaskSEDmesonsFilterCJTest* task = mgr->GetTask(taskFiltername.Data());
  if (task) {
    ...
    // create the task
    task = new AliAnalysisTaskSEDmesonsFilterCJTest(taskFiltername.Data(), analysiscuts, cand);
    task->SetMC(theMCon);
