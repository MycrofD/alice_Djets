void AddTasksFlavourJetMC(const Int_t iCandType = 1 /*0 = D0, 1=Dstar...*/,
   ...
   )
{
   ...
   const Int_t iJetType = 0; /*0=Full, 1=Charged, 2=Neutral*/
   /*
   ...
   //gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/FlavourJetTasks/macros/AddTaskDFilterAndCorrelations.C");
    ...
    for(Int_t i=0; i<1  ; i++)
    {
       ...
       //This is the particle container with the tracks of the event
        ...
        AliEmcalJetTask *taskFJMCDandTracks = AddTaskEmcalJet(MCDcandAndTracks,"",1,aRadius[0],AliJetContainer::kFullJet,0.,0.0,0.005,1,AKTJet,0.,kFALSE,kFALSE);
      ...
      //  rhotask->SetVzRange(-10,10);
        ...
        AliAnalysisTaskFlavourJetCorrelationsMy *CorrTask = AddTaskDFilterAndCorrelations(
                                                                                         iCandType,
                                                                                         sCutFile,
                                                                                         bIsMC,
                                                                                         bIsReco,
                                                                                         ...
                                                                                         acctype,
                                                                                         dJetAreaCut,
                                                                                         AliAnalysisTaskFlavourJetCorrelationsMy::kConstituent);


     CorrTask->SetBuildResponseMatrix(kFALSE);
     CorrTask->SetBuildResponseMatrixEff(kTRUE);
     CorrTask->SetUsePythia(kTRUE);
