...
void AnalysisTrainCorrJetsLocal (
                                 ...
                                 const char*    pattern             = "/pass1_FAST/AOD/*/AliAOD.root",   // file pattern (here one can specify subdirs like passX etc.) (used on grid)
                                 const char*    gridDir             = "/alice/data/2017/LHC17p/",
                                ...
                                const char*    uniqueName          = "D0Jet_test",           // sets base string for the name of the task on the grid
                                 ...
                                 )
{
    ...
    gROOT->LoadMacro("AddTasksFlavourJet.C");
     ...
     AddTasksFlavourJet(0,"D0toKpiCuts_pp5TeV_pPbBase_newNorm.root",0.,0.,"TPCFID",runPeriod,0,pSel,isMC,isReco,isMap,bRM,bRMEff,bPythia,isPrompt,"MB"); // Jet(1,..) for D*
