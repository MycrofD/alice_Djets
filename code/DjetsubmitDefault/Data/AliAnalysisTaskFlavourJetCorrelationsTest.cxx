...
#include "AliAnalysisTaskFlavourJetCorrelationsTest.h"
...
ClassImp(AliAnalysisTaskFlavourJetCorrelationsTest)


//_______________________________________________________________________________

AliAnalysisTaskFlavourJetCorrelationsTest::AliAnalysisTaskFlavourJetCorrelationsTest() :
AliAnalysisTaskEmcalJet("AliAnalysisTaskFlavourJetCorrelationsTest",kTRUE),
fUseMCInfo(kTRUE), 
fUseReco(kTRUE),
fUsePythia(kFALSE),
fBuildRM(kFALSE),
...
fResponseMatrix()
{
   ...
   Info("AliAnalysisTaskFlavourJetCorrelationsTest","Calling Constructor");
   fCuts=cuts;
...
AliAnalysisTaskFlavourJetCorrelationsTest::~AliAnalysisTaskFlavourJetCorrelationsTest() {
   ...
   Info("~AliAnalysisTaskFlavourJetCorrelationsTest","Calling Destructor");  
...
void AliAnalysisTaskFlavourJetCorrelationsTest::Init(){
   //
   // Initialization
   //
...
void AliAnalysisTaskFlavourJetCorrelationsTest::UserCreateOutputObjects() { 
   // output 
...
void AliAnalysisTaskFlavourJetCorrelationsTest::ConstituentCorrelationMethod(Bool_t IsBkg, AliAODEvent* aodEvent)
{
...
void AliAnalysisTaskFlavourJetCorrelationsTest::AngularCorrelationMethod(Bool_t IsBkg, AliAODEvent* aodEvent)
{
    AliJetContainer* JetCont = GetJetContainer(0);
...
void AliAnalysisTaskFlavourJetCorrelationsTest::CreateResponseMatrix(AliEmcalJet* jet)
{
...
void AliAnalysisTaskFlavourJetCorrelationsTest::CreateMCResponseMatrix(AliEmcalJet* MCjet, AliAODEvent* aodEvent)
{
...
void AliAnalysisTaskFlavourJetCorrelationsTest::FillDJetHistograms(AliEmcalJet* jet, Double_t rho, Bool_t IsBkg, AliAODEvent* aodEvent)
{
...
void AliAnalysisTaskFlavourJetCorrelationsTest::Terminate(Option_t*)
{    
...
void  AliAnalysisTaskFlavourJetCorrelationsTest::SetMassLimits(Double_t range, Int_t pdg){
   Float_t mass=0;
...
void  AliAnalysisTaskFlavourJetCorrelationsTest::SetMassLimits(Double_t lowlimit, Double_t uplimit){
   if(uplimit>lowlimit)
   {
      fMinMass = lowlimit;
      fMaxMass = uplimit;
...
Bool_t AliAnalysisTaskFlavourJetCorrelationsTest::SetD0WidthForDStar(Int_t nptbins,Float_t *width){
   if(nptbins>30) {
...
Double_t AliAnalysisTaskFlavourJetCorrelationsTest::Z(AliVParticle* part,AliEmcalJet* jet, Double_t rho) const{
...
Double_t AliAnalysisTaskFlavourJetCorrelationsTest::Z(AliVParticle* part,AliEmcalJet* jet) const{
...
//_______________________________________________________________________________
Double_t AliAnalysisTaskFlavourJetCorrelationsTest::Z(Double_t* p, Double_t *pj) const{
...
//_______________________________________________________________________________
Double_t AliAnalysisTaskFlavourJetCorrelationsTest::ZT(Double_t* p, Double_t *pj) const{
...
Bool_t  AliAnalysisTaskFlavourJetCorrelationsTest::DefineHistoForAnalysis(){
   ...
   fOutput->Add(fhPtJet);
    ...
    if(fBuildRM == kTRUE || fBuildRMEff == kTRUE)
    {
        ...
        const Int_t RMnbins[nRMAxis] = {nbinsSpsz,nbinsSpsptjet,nbinsSpsptD,nbinsSpsy,nbinsSpsz,nbinsSpsptjet,nbinsSpsptD,nbinsSpsy,nbinsSpsy};
...
void AliAnalysisTaskFlavourJetCorrelationsTest::FillHistogramsD0JetCorr(AliAODRecoDecayHF* candidate, Double_t z, Double_t ptD, Double_t ptj, Double_t jetEta, Bool_t IsBkg, Bool_t bDInEMCalAcc, Bool_t bJetInEMCalAcc, AliAODEvent* aodEvent){
...
void AliAnalysisTaskFlavourJetCorrelationsTest::FillHistogramsDstarJetCorr(AliAODRecoCascadeHF* dstar,  Double_t z, Double_t ptD, Double_t ptj, Double_t jetEta, Bool_t IsBkg, Bool_t bDInEMCalAcc, Bool_t bJetInEMCalAcc){
...
void AliAnalysisTaskFlavourJetCorrelationsTest::FillHistogramsMCGenDJetCorr(Double_t z,Double_t ptD,Double_t ptjet, Double_t yD, Double_t jetEta, Bool_t bDInEMCalAcc, Bool_t bJetInEMCalAcc){
...
Float_t AliAnalysisTaskFlavourJetCorrelationsTest::DeltaR(AliEmcalJet *p1, AliVParticle *p2, Double_t rho) const {
...
//_______________________________________________________________________________
Float_t AliAnalysisTaskFlavourJetCorrelationsTest::CheckDeltaR(AliEmcalJet *p1, AliVParticle *p2) const {
    //Calculate DeltaR between p1 and p2: DeltaR=sqrt(Delataphi^2+DeltaEta^2)
    if(!p1 || !p2) return -1;
...
Int_t AliAnalysisTaskFlavourJetCorrelationsTest::IsDzeroSideBand(AliAODRecoCascadeHF *candDstar){
...
Bool_t AliAnalysisTaskFlavourJetCorrelationsTest::InEMCalAcceptance(AliVParticle *vpart){
