void Dstarjet_woSDDProd_806cut_ranCones_1_merge(const char *dir, Int_t stage=0)
{
...
// Set temporary compilation directory to current one
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("Dstarjet_woSDDProd_806cut_ranCones_1.root");
   if (!mgr) {
