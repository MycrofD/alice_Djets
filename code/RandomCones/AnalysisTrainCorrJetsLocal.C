...
void AnalysisTrainCorrJetsLocal (
                                 ...
                                 //const char*    runNumbers          = "265525 265521 265501 265500 265499 265435",
                                ...
                                const char*    uniqueName          = "Dstarjet_woSDDProd_806cut_RandCones",           // sets base string for the name of the task on the grid
                                //const char*    uniqueName          = "DstarjetMC_fast_RMEffPYTHIA_nonprompt_set6Impr",           // sets base string for the name of the task on the grid
                                 ...
                                 const char*    addCXXs             = "AliAnalysisTaskSEDmesonsFilterCJMy.cxx AliAnalysisTaskFlavourJetCorrelationsMy.cxx", // to add local tasks
                                 //const char*    addCXXs             = "AliAnalysisTaskFlavourJetCorrelationsMy.cxx AliAnalysisTaskSEDmesonsFilterCJMy.cxx", // to add local tasks
                                 const char*    addHs               = "AliAnalysisTaskSEDmesonsFilterCJMy.h AliAnalysisTaskFlavourJetCorrelationsMy.h",
                                 ...
                                 )
{
    ...
    gROOT->LoadMacro("AddTasksFlavourJetMy.C");
   
     AddTasksFlavourJetMy(1,"alien:///alice/cern.ch/user/b/btrzecia/pPb2016/DstarCuts/5TeVPBp2016_cuts806Base.root",0.,0.557,"TPCFID",runPeriod,0,pSel,isMC,isReco,isMap,bRM,bRMEff,bPythia,isPrompt,"MB"); // Jet(1,..) for D*
