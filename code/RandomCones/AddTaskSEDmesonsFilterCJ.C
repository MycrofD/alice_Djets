...
AliAnalysisTaskSEDmesonsFilterCJMy *AddTaskSEDmesonsFilterCJ(AliAnalysisTaskSEDmesonsFilterCJMy::ECandidateType cand = AliAnalysisTaskSEDmesonsFilterCJMy::kDstartoKpipi,
                                                           ...
                                                           TString suffix = "")
{
  ...
  AliAnalysisTaskSEDmesonsFilterCJMy* task = mgr->GetTask(taskFiltername.Data());
  if (task) {
    ...
    // create the task
    task = new AliAnalysisTaskSEDmesonsFilterCJMy(taskFiltername.Data(), analysiscuts, cand);
    task->SetMC(theMCon);
