...
#include "AliAnalysisTaskSEDmesonsFilterCJMy.h"

ClassImp(AliAnalysisTaskSEDmesonsFilterCJMy)

//_______________________________________________________________________________
AliAnalysisTaskSEDmesonsFilterCJMy::AliAnalysisTaskSEDmesonsFilterCJMy() :
...
//_______________________________________________________________________________
AliAnalysisTaskSEDmesonsFilterCJMy::AliAnalysisTaskSEDmesonsFilterCJMy(const char *name, AliRDHFCuts *cuts, ECandidateType candtype) :
  ...
  fHistDeltaRDKR(0)
{
  ...
  Info("AliAnalysisTaskSEDmesonsFilterCJMy","Calling Constructor");
  ...
  switch (fCandidateType) {
    ...
    case 1 :
      ...
      break;
    default :
      Warning("AliAnalysisTaskSEDmesonsFilterCJMy", "%d not accepted!!", fCandidateType);
      break;
  }
...
AliAnalysisTaskSEDmesonsFilterCJMy::~AliAnalysisTaskSEDmesonsFilterCJMy()
{
  ...
  Info("~AliAnalysisTaskSEDmesonsFilterCJMy","Calling Destructor");
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::Init()
{
  //
  // Initialization
  //
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::UserCreateOutputObjects()
{
  //
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::ExecOnce()
{
  //
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskSEDmesonsFilterCJMy::Run()
{
  //
  // Analysis execution
  //
  ...
  for (Int_t icharm = 0; icharm < nD; icharm++) {   //loop over D candidates
    ...
    if (fCandidateType == kDstartoKpipi) {
      ...
      if (!dstar) {
        Error("AliAnalysisTaskSEDmesonsFilterCJMy::UserExec","Candidate type is D* but object type is wrong (should be AliAODRecoCascadeHF)");
        continue;
      }
    }
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::ProcessD0(AliAODRecoDecayHF2Prong* charmCand, Int_t isSelected)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::ProcessDstar(AliAODRecoCascadeHF* dstar, Int_t isSelected)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::FillD0MCTruthKinHistos(AliAODRecoDecayHF2Prong* charmCand, Int_t isSelected, Int_t isD0)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::FillDStarMCTruthKinHistos(AliAODRecoCascadeHF* dstar, Int_t /*isSelected*/, Int_t isDstar)
{
  // Fill some histogram with kinematic information of the D0 candidate.
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::FillDstarSideBands(AliAODRecoCascadeHF* dstar)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::SetMassLimits(Double_t range, Int_t pdg)
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::SetMassLimits(Double_t lowlimit, Double_t uplimit)
{
  // Set the mass limits.
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskSEDmesonsFilterCJMy::SetD0WidthForDStar(Int_t nptbins, Float_t* width)
{
...
//_______________________________________________________________________________
Bool_t AliAnalysisTaskSEDmesonsFilterCJMy::DefineHistoForAnalysis()
{
...
//_______________________________________________________________________________
Float_t AliAnalysisTaskSEDmesonsFilterCJMy::DeltaR(AliVParticle *p1, AliVParticle *p2) const
{
...
//_______________________________________________________________________________
void AliAnalysisTaskSEDmesonsFilterCJMy::AddEventTracks(TClonesArray* coll, AliParticleContainer* tracks)
{
  //
...
//_______________________________________________________________________________
Double_t AliAnalysisTaskSEDmesonsFilterCJMy::AddDaughters(AliAODRecoDecay* cand, TObjArray& daughters)
{
...
Int_t AliAnalysisTaskSEDmesonsFilterCJMy::CheckOrigin(AliAODRecoDecay* cand, TClonesArray* mcArray)
{
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJMy::CheckOrigin(AliAODRecoDecay* cand, AliStack* stack)
{
  // Checks whether the mother of the D meson candidate comes from a charm or a bottom quark.
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJMy::CheckOrigin(AliAODMCParticle* part, TClonesArray* mcArray)
{
  ...
  while (mother >= 0) {
    ...
    if (mcGranma >= 0) {
      ...
      ::Error("AliAnalysisTaskSEDmesonsFilterCJMy::CheckOrigin", "Could not retrieve mother particle %d!", mother);
      break;
    }
  }
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJMy::CheckOrigin(Int_t ipart, AliStack* stack)
{
  // Checks whether the mother of the particle comes from a charm or a bottom quark.
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJMy::CheckDecayChannel(AliAODMCParticle* part, TClonesArray* mcArray)
{
...
//_________________________________________________________________________________________________
Int_t AliAnalysisTaskSEDmesonsFilterCJMy::CheckDecayChannel(Int_t ipart, AliStack* stack)
{
  // Determine the decay channel
