#ifndef AliAnalysisTaskSEDmesonsFilterCJMy_H
#define AliAnalysisTaskSEDmesonsFilterCJMy_H
/**************************************************************************
...
class AliAnalysisTaskSEDmesonsFilterCJMy : public AliAnalysisTaskEmcal 
{
 ...
 public:
  ...
  AliAnalysisTaskSEDmesonsFilterCJMy();
  AliAnalysisTaskSEDmesonsFilterCJMy(const Char_t* name,AliRDHFCuts* cuts,ECandidateType candtype);
  virtual ~AliAnalysisTaskSEDmesonsFilterCJMy();
 ...
 private:
  ...
  AliAnalysisTaskSEDmesonsFilterCJMy(const AliAnalysisTaskSEDmesonsFilterCJMy &source);
  AliAnalysisTaskSEDmesonsFilterCJMy& operator=(const AliAnalysisTaskSEDmesonsFilterCJMy& source); 

  ClassDef(AliAnalysisTaskSEDmesonsFilterCJMy, 6); // task for selecting D mesons to be used as an input for D-Jet correlations
};
