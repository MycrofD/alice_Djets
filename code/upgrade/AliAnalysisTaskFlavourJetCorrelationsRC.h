#ifndef AliAnalysisTaskFlavourJetCorrelationsRC_H
#define AliAnalysisTaskFlavourJetCorrelationsRC_H
/**************************************************************************
...
class AliAnalysisTaskFlavourJetCorrelationsRC : public AliAnalysisTaskEmcalJet
{
...
public:
   ...
   AliAnalysisTaskFlavourJetCorrelationsRC();
   AliAnalysisTaskFlavourJetCorrelationsRC(const Char_t* name,AliRDHFCuts* cuts, ECandidateType candtype);
   virtual ~AliAnalysisTaskFlavourJetCorrelationsRC();
...
private:
   ...
   AliAnalysisTaskFlavourJetCorrelationsRC(const AliAnalysisTaskFlavourJetCorrelationsRC &source);
   AliAnalysisTaskFlavourJetCorrelationsRC& operator=(const AliAnalysisTaskFlavourJetCorrelationsRC& source);
   ...
   ClassDef(AliAnalysisTaskFlavourJetCorrelationsRC,8); // class for charm-jet CorrelationsExch
};
