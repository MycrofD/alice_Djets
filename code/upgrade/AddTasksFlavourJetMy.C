void AddTasksFlavourJetMy(const Int_t iCandType = 1 /*0 = D0, 1=Dstar...*/,
  ...
  // AliAnalysisTaskSEImproveITS *taskImprover = AddTaskImproveITS(kFALSE,"alien:///alice/cern.ch/user/a/afestant/filesForImprover/pPb2016/ITSgraphs_Current.root","alien:///alice/cern.ch/user/a/afestant/filesForImprover/pPb2016/ITSgraphs_NewAll-X0.3-Res4um.root",0 );
   ...
   //gROOT->LoadMacro("$ALICE_PHYSICS/PWGJE/FlavourJetTasks/macros/AddTaskDFilterAndCorrelations.C");
    ...
    for(Int_t i=0; i<2  ; i++)
    {
        ...
        AliAnalysisTaskSEDmesonsFilterCJMy *filter = AddTaskSEDmesonsFilterCJ(iCandType,sCutFile,bIsMC,bIsReco,TaskText);
       ...
       // rhotask = (AliAnalysisTaskRhoSparse*) AddTaskRhoSparse(taskFJ2->GetName(), taskFJDandTracks->GetName(), DcandAndTracks,"", rhoName, aRadius[0], "TPCFID", 0.01, 0., 0, 0, 0, kTRUE);
