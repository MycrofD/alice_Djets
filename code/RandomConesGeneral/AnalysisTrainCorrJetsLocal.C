...
void AnalysisTrainCorrJetsLocal (
                                 ...
                                 const char*    pattern             = "/pass1_CENT_woSDD/AOD/*AliAOD.root",   // file pattern (here one can specify subdirs like passX etc.) (used on grid)
                                 const char*    gridDir             = "/alice/data/2016/LHC16q/",
                                 //const char*    runNumbers          = "265525 265521 265501 265500 265499 265435 265427 265426 265425 265424 265422 265421 265420 265419 265388 265387 265385 265384 265383 265381 265378 265377 265344 265343 265342 265339 265338 265336 265335 265334 265332 265309 ",
                                 const char*    runNumbers          = "265525",
                                ...
                                const char*    uniqueName          = "JetUERandCones_woSDDProd_2_0",           // sets base string for the name of the task on the grid
                                //const char*    uniqueName          = "DstarjetMC_fast_RMEffPYTHIA_nonprompt_set6Impr",           // sets base string for the name of the task on the grid
                                 ...
                                 const char*    addCXXs             = "", // to add local tasks
                                 //const char*    addCXXs             = "AliAnalysisTaskJetUEStudiesMy.cxx", // to add local tasks
                                 const char*    addHs               = "",
                                 //const char*    addHs               = "AliAnalysisTaskJetUEStudiesMy.h",
                                 ...
                                 )
{
   ...
   // gSystem->AddLinkedLibs("-std=c++11");
    ...
    //gROOT->LoadMacro("AliAnalysisTaskJetUEStudiesMy.cxx++g");
   // gROOT->LoadMacro("AliAnalysisTaskJetUEStudiesMy.cxx");
    gROOT->LoadMacro("AddTasksUE.C");
...
void LoadLibs()
{
    ...
    //gSystem->AddIncludePath("-std=c++11 -Wall -pedantic");
//    gSystem->AddIncludePath("-std=c++11 -Wall");
   // gSystem->AddIncludePath("-std=c++0x");

   // gSystem->AddIncludePath("-Wnoc++11-extensions");
                                    ...
                                    Int_t workerTTL, Bool_t isMC)
{
    ...
    plugin->SetAliPhysicsVersion("vAN-20170731-1");
    ...
    //plugin->SetupPar("/home/basia/Work/alice/soft/sw/ubuntu1604_x86-64/AliPhysics/0-1/PARfiles/PWGJEEMCALJetTasks.par");
    //plugin->SetupPar("/home/basia/Work/alice/soft/sw/BUILD/f085ed0f25c3b6e909aec0650becbba1ada103c9/AliPhysics/PWGJE/EMCALJetTasks/PWGJEEMCALJetTasks.par");
    plugin->SetupPar("PWGJEEMCALJetTasks.par");
