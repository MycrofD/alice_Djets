/**
 * \file AliAnalysisTaskJetUEStudiesMy.h
...
#ifndef ALIANALYSISTASKJETUESTUDIESMY_H
#define ALIANALYSISTASKJETUESTUDIESMY_H
 ...
 */
class AliAnalysisTaskJetUEStudiesMy : public AliAnalysisTaskJetUE {
 public:

  AliAnalysisTaskJetUEStudiesMy();
  AliAnalysisTaskJetUEStudiesMy(const char *name);
  virtual ~AliAnalysisTaskJetUEStudiesMy() { delete fRandom; }

  void           UserCreateOutputObjects();

  void           AddAltRho(TString rhoName)    { fAlternativeRho.insert(std::make_pair(rhoName, nullptr));  }

  static AliAnalysisTaskJetUEStudiesMy* AddTaskJetUEStudies(
 ...
 private:
  AliAnalysisTaskJetUEStudiesMy(const AliAnalysisTaskJetUEStudiesMy&);            // not implemented
  AliAnalysisTaskJetUEStudiesMy &operator=(const AliAnalysisTaskJetUEStudiesMy&); // not implemented

  /// \cond CLASSIMP
  ClassDef(AliAnalysisTaskJetUEStudiesMy, 1);
  /// \endcond
};
#endif
