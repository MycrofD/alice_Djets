void JetUERandCones_woSDDProd_2_merge(const char *dir, Int_t stage=0)
{
...
// Set temporary compilation directory to current one
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("JetUERandCones_woSDDProd_2.root");
   if (!mgr) {
