...
#include "AliAnalysisTaskJetUEStudiesMy.h"

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskJetUEStudiesMy);
/// \endcond

/// Default constructor for ROOT I/O purposes
AliAnalysisTaskJetUEStudiesMy::AliAnalysisTaskJetUEStudiesMy() :
...
AliAnalysisTaskJetUEStudiesMy::AliAnalysisTaskJetUEStudiesMy(const char *name) :
...
void AliAnalysisTaskJetUEStudiesMy::UserCreateOutputObjects()
{
 ...
 */
void AliAnalysisTaskJetUEStudiesMy::ExecOnce()
{
 ...
 * Run the analysis.
 */
Bool_t AliAnalysisTaskJetUEStudiesMy::Run()
{
 ...
 */
Bool_t AliAnalysisTaskJetUEStudiesMy::FillHistograms()
{
  TString histname;
...
Int_t AliAnalysisTaskJetUEStudiesMy::SumParticles(Double_t& pt, Double_t eta, Double_t phi, Double_t maxD2, std::map<std::string, T*>& CollArray, std::array<Int_t, MAX_CONSTITUENTS>& ConstList)
{
 ...
 */
AliEmcalJet* AliAnalysisTaskJetUEStudiesMy::GetJetCone(Double_t radius, Double_t eta, Double_t phi)
{
  Double_t pt = 0;
 ...
 */
AliEmcalJet* AliAnalysisTaskJetUEStudiesMy::GetRandomCone(AliJetContainer* jetCont)
{
 ...
 */
AliEmcalJet* AliAnalysisTaskJetUEStudiesMy::GetRandomConePerp(AliJetContainer* jetCont, AliEmcalJet* leadJet)
{
  Double_t eta = fRandom->Uniform(jetCont->GetMinEta() + jetCont->GetJetRadius(), jetCont->GetMaxEta() - jetCont->GetJetRadius());
 ...
 * @param leadJet Leading jet
 */
AliEmcalJet* AliAnalysisTaskJetUEStudiesMy::GetRandomConeExclLead(AliJetContainer* jetCont, AliEmcalJet* leadJet)
{
  Double_t eta = fRandom->Uniform(jetCont->GetMinEta() + jetCont->GetJetRadius(), jetCont->GetMaxEta() - jetCont->GetJetRadius());
  Double_t phi = 0;
  if (jetCont->GetMinPhi() == -10 && jetCont->GetMaxPhi() == 10) {
...
AliAnalysisTaskJetUEStudiesMy* AliAnalysisTaskJetUEStudiesMy::AddTaskJetUEStudies(TString trackName, TString clusName,
    Double_t trackPtCut, Double_t clusECut, TString suffix)
{
  // Get the pointer to the existing analysis manager via the static access method.
  AliAnalysisManager *mgr = AliAnalysisManager::GetAnalysisManager();
  if (!mgr) {
    ::Error("AliAnalysisTaskJetUEStudiesMy", "No analysis manager to connect to.");
    return nullptr;
  }
  ...
  if (!handler) {
    ::Error("AliAnalysisTaskJetUEStudiesMy", "This task requires an input event handler");
    return nullptr;
  }
  ...
  TString name("AliAnalysisTaskJetUEStudiesMy");
  if (strcmp(suffix,"")) {
    name += "_";
    name += suffix;
  }

  AliAnalysisTaskJetUEStudiesMy* jetTask = new AliAnalysisTaskJetUEStudiesMy(name);
