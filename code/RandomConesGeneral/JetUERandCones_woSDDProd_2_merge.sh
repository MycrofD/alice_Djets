...
export ARG="JetUERandCones_woSDDProd_2_merge.C(\"$1\",$2)"
root -b -q -x $ARG
RET=$?
if [ "$RET" != "0" ];then
  echo "======== ERROR : JetUERandCones_woSDDProd_2.C finished with NON zero code: $RET ========"
...
echo "======== JetUERandCones_woSDDProd_2_merge.C finished with exit code: $? ========"
echo "############## memory after: ##############"
free -m
