void JetUERandCones_woSDDProd_2_0_merge(const char *dir, Int_t stage=0)
{
...
// Set temporary compilation directory to current one
   ...
   TString outputFile;
   Bool_t merged = kTRUE;
   AliAnalysisManager *mgr = AliAnalysisAlien::LoadAnalysisManager("JetUERandCones_woSDDProd_2_0.root");
   if (!mgr) {
