...
void AnalysisTrainCorrJetsLocalData (
                                ...
                                // const char*    runNumbers          = "265525 265521 265501 265500 265499 265435 265427 265426 265425", // list 1
                                //const char*    runNumbers          = "265424 265422 265421 265420 265419 265388 265387 265385 ", // list 2
                                 const char*    runNumbers          = "265384 265383 265381 265378 265377 265344 265343 265342", // list 3
                                //const char*    runNumbers          = " 265339 265338 265336 265335 265334 265332 265309", // list 4
                                 ...
                                 //const char*    uniqueName          = "RC03_DzeroHFjet_woSDDProd_SQMcut_4",           // sets base string for the name of the task on the grid
                                 const char*    uniqueName          = "RC03_DzeroHFjetTrigg_woSDDProd_SQMcut_3",
                                //const char*    uniqueName          = "RC03_Alljet_woSDDProd_SQMcut_1",           // sets base string for the name of the task on the grid
                                 ...
                                 Bool_t         isHFJet             = kTRUE,
                                 Bool_t         isLeadHFJet         = kTRUE,
                                 Bool_t         isReco              = kTRUE,
                                 Bool_t         isMap               = kFALSE,
                                 Bool_t         bRM                 = kFALSE,
                                 Bool_t         bRMEff              = kTRUE,
                                 ...
                                 )
{
    ...
    gROOT->LoadMacro("AddTasksFlavourJetMyData.C");

     AddTasksFlavourJetMyData(0,"alien:///alice/cern.ch/user/b/btrzecia/pPb2016/D0Cuts/D0toKpiCuts_pPb2016_0_100_PreliminarySQM_MC.root",0.,0.557,"TPCFID",runPeriod,0,pSel,isHFJet,isLeadHFJet,isMC,isReco,isMap,bRM,bRMEff,bPythia,isPrompt,"MB"); // Jet(1,..) for D*
