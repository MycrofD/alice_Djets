...
void AliAnalysisTaskFlavourJetCorrelationsTest::GetHFJet(AliEmcalJet*& jet, Bool_t IsBkg)
{
    ...
    if(JetIsHF){
        ...
        if( (counter-1) == fLeadingJetIds[0] ) { fhDleadStat->Fill(1); fhDleadStatJetPt->Fill(1,jetPtCorr); }  
...
void AliAnalysisTaskFlavourJetCorrelationsTest::FillHistogramsD0JetCorr(AliAODRecoDecayHF* candidate, Double_t z, Double_t ptD, Double_t ptj, Double_t jetTracks, Bool_t IsBkg, Bool_t bDInEMCalAcc, Bool_t bJetInEMCalAcc, AliAODEvent* aodEvent){
...
void AliAnalysisTaskFlavourJetCorrelationsTest::FillHistogramsDstarJetCorr(AliAODRecoCascadeHF* dstar,  Double_t z, Double_t ptD, Double_t ptj, Double_t jetTracks, Bool_t IsBkg, Bool_t bDInEMCalAcc, Bool_t bJetInEMCalAcc){
...
void AliAnalysisTaskFlavourJetCorrelationsTest::FillHistogramsMCGenDJetCorr(Double_t z,Double_t ptD,Double_t ptjet, Double_t jetTracks, Double_t yD, Bool_t bDInEMCalAcc, Bool_t bJetInEMCalAcc){
